...
@Entity
@Table(name="ADDRESS_PERMANENT")
public class Address_Permanent {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "course_seq")
	@SequenceGenerator(name = "course_seq", sequenceName = "ADDRESS_PERMANENT_SEQ", allocationSize = 1)
	...
	public String toString() {
		return "Address_Permanent [id=" + id + ", city=" + city + ", state=" + state + ", country=" + country
