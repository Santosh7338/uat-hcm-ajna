...
@Entity
@Table(name = "MAIL_COMMUNICATIONS")
public class MailCommunication implements Serializable {
	...
	@SequenceGenerator(name = "course_seq", sequenceName = "MAIL_COMMUNICATION_SEQ", allocationSize = 1)
	...
	public String toString() {
		return "MailCommunication [mail_no=" + mail_no + ", comm_type=" + comm_type + ", sub_type=" + sub_type
				+ ", from_mail=" + from_mail + ", to_mail=" + to_mail + ", subject=" + subject + ", body=" + body
				+ ", resp1=" + resp1 + ", resp2=" + resp2 + ", status=" + status + ", cc_mail=" + cc_mail
				+ ", created_by=" + created_by + ", creation_date=" + creation_date + ", last_updated_by="
				+ last_updated_by + ", last_update_date=" + last_update_date + "]";
	}

	public MailCommunication(int mail_no, String comm_type, String sub_type, String from_mail, String to_mail,
			String subject, String body, String resp1, String resp2, String status, String cc_mail, int created_by,
