...
public interface LeavesService {
	...
	public int checkInLeave(String final_date, int emp_code, int int_mon, String string_mon, String afterdays, int daycount, String daystatus);

	public int checkInLeaveHd(String final_date, int emp_code, int int_mon, String string_mon, String afterdays,
			int daycount);
...
public List<PendingApprovals> getLeaveRequestApprovalPendingListForFr(String currDate,String weekday,int emp);
	...
	public List<Rules_Documents> getRulesDocument(int i);
